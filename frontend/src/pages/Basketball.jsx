...
import BasketballCollection from "../components/BasketballCollection";
...
const Basketball = () => {
    ...
    const handleFilterAndSort = () => {
        ...
        productsCopy = productsCopy.filter((item) => item.sportsCategory === "basketball");
    ...
    return (
        <>
            <div className="relative w-full h-[150px] sm:h-[200px] md:h-[250px] lg:h-[285px]">
                <img src={assets.men_basketball} alt="Billiards" className="w-full h-full object-cover" />
