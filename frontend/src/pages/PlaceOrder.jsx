...
const PlaceOrder = () => {
    ...
    const { navigate, backendUrl, token, cartItems, setCartItems, getCartAmount, products } =
            ...
            <div className='mt-8'>
                ...
                <div className='mt-12'>
                    ...
                    <div className='w-full text-end mt-8'>
                        <button className='bg-black text-white px-16 py-3 text-sm active:bg-red-500'>
                            PLACE ORDER
                        </button>
                    </div>
                </div>
