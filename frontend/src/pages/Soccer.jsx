...
import SoccerCollection from "../components/SoccerCollection";
...
const Soccer = () => {
    ...
    const handleFilterAndSort = () => {
        ...
        productsCopy = productsCopy.filter((item) => item.sportsCategory === "soccer");
    ...
    return (
        <>
            <div className="relative w-full h-[150px] sm:h-[200px] md:h-[250px] lg:h-[285px]">
                <img src={assets.soccer} alt="Billiards" className="w-full h-full object-cover" />
