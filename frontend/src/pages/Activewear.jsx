...
import ActivewearCollection from "../components/ActivewearCollection";
...
const Activewear = () => {
    ...
    const handleFilterAndSort = () => {
        ...
        productsCopy = productsCopy.filter((item) => item.sportsCategory === "activewear");
    ...
    return (
        <>
            <div className="relative w-full h-[150px] sm:h-[200px] md:h-[250px] lg:h-[285px]">
                <img src={assets.activewear} alt="Billiards" className="w-full h-full object-cover" />
