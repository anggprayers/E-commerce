    ...
    return (
        <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-white'>
            <div>
                ...
                <p className='text-white/80'>We offer hassle free exchange policy</p>
            </div>
            <div>
                <img className='w-12 m-auto mb-5' src={assets.quality_icon} alt='' />
                <p className='font-semibold'>7 Days Return Policy</p>
                <p className='text-white/80'>We provide 7 days free return policy</p>
            </div>
            <div>
                <img className='w-12 m-auto mb-5' src={assets.support_icon} alt='' />
                <p className='font-semibold'>Reliable Customer Support</p>
                <p className='text-white/80'>We provide 24/7 customer support</p>
            </div>
        </div>
    );
};
